...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Editar Sexo'), array('action' => 'edit', $sexo['Sexo']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Eliminar Sexo'), array('action' => 'delete', $sexo['Sexo']['id']), null, __('Esta seguro que desea eliminar el registro # %s?', $sexo['Sexo']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($sexo['Persona'] as $persona): ?>
		<tr>

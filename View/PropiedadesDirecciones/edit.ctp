...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('PropiedadesDireccion.id')), null, __('Esta seguro de que quiere eliminar el registro # %s?', $this->Form->value('PropiedadesDireccion.id'))); ?></li>
		<li><?php echo $this->Html->link(__('Listar Propiedades Direcciones'), array('action' => 'index'));?></li>

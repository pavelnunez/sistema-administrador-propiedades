<div class="personasTipos form">
<?php echo $this->Form->create('PersonasTipo');?>
	<fieldset>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('PersonasTipo.id')), null, __('Esta seguro de que quiere eliminar el registro # %s?', $this->Form->value('PersonasTipo.id'))); ?></li>

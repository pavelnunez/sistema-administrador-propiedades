 ...
 */
	public function view($id = null) {
		$this->Nacionalidad->id = $id;
		if (!$this->Nacionalidad->exists()) {
			throw new NotFoundException(__('Invalid nacionalidad'));
		}
		$this->set('nacionalidad', $this->Nacionalidad->read(null, $id));
	}
 ...
 */
	public function edit($id = null) {
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			...
			$this->request->data = $this->Nacionalidad->read(null, $id);
		}
	}
